...
namespace BlogProject.Controllers
{
    public class CommentsController : Controller
    {
        ...
        //Might make different indexes like ModeratedIndex and then return View("Index", The list)
        ...
        public async Task<IActionResult> Create([Bind("PostId,Body")] Comment comment, string Slug)
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("Details", "Posts", new { slug = Slug }, "commentSection"); //should return to the post detail action
            }
            //ViewData["BlogUserId"] = new SelectList(_context.Users, "Id", "Id", comment.BlogUserId);
            //ViewData["ModeratorId"] = new SelectList(_context.Users, "Id", "Id", comment.ModeratorId);
            //ViewData["PostId"] = new SelectList(_context.Posts, "Id", "Abstract", comment.PostId);
            
            //what we should do if it failed
            return View(comment);
        }
